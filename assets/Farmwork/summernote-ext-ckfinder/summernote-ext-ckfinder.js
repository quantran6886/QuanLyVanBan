    ...
    'CKFinder': function(context) {
      ...
      context.memo('button.CKFinder', function() {
        ...
        var button = ui.button({
          contents: '<i class="note-icon-picture"/>&nbsp;&nbsp;CKFinder',
          tooltip: 'CKFinder',
          click: function() {
             CKFinder.modal( {
		...
		//  'https://example.com/assets/plugins/ckfinder/plugins/ImageInfo/ImageInfo.js',
		//  'https://example.com/assets/plugins/ckfinder/plugins/CustomButton/CustomButton.js'
		//  ],
                 chooseFiles: true,
